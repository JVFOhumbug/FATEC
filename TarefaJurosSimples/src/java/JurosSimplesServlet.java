...
public class JurosSimplesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<p><b>Nome:</b>João Victor Ferreira de Oliveira</p>");
            out.println("<p><b>RA:</b> 1290481922027</p>");
            out.println("<p>-------------------------------------------</p>");
            ...
            double tempo = Double.parseDouble(request.getParameter("Meses"));
            double jurosR = juros / 100;
            double conta = VP*(1+jurosR*tempo);
            out.println("Valor presente: " + VP);
            out.println("<br><br>");
            out.println("Juros (%): " + juros);
            out.println("<br><br>");
            out.println("Tempo (meses): " + tempo);
            out.println("<br><br>");
            out.println("<b>Resultado (valor futuroMeses):</b>" + conta);
            out.println("<br><br>");
